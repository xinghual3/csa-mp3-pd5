...
## • Struggles with this question, all we have to use *Math.random()* correctly and understanding correctly what the question ask. The formula of Math.random(): *(int)(Math.random() * (max - min + 1)) + min*
